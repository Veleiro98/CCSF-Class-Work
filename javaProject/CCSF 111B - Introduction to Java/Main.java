...
(the "Notes" from the compiler are because my outputInOrder function
uses Comparable without specifying what types are being compared. So you can ignore those warnings):
